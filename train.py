...
def train_model(dataset):
    ...
    hsa_model = HSA_model(hyperparameters['HSA_model']['modality_indices'][dataset], n_window, n_timesteps, n_features, n_outputs, d_model=hyperparameters['HSA_model']['d_model'], num_heads = hyperparameters['HSA_model']['num_heads'], dff=hyperparameters['HSA_model']['dff'], dropout_rate=hyperparameters['HSA_model']['dropout']).get_model()
    ...
    hsa_vae.fit(X_train, epochs=hyperparameters['train']['epochs'], batch_size=hyperparameters['train']['batch_size'])
