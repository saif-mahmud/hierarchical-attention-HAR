...
def novelty_detection_exp(hsa_model, hsa_vae, X_train, X_test, X_holdout):
    hierarchical_model = tf.keras.Model(inputs=hsa_model.input, outputs=hsa_model.get_layer('combined_sensor_self_attention_1').output, name='hierarchical_encoder')
